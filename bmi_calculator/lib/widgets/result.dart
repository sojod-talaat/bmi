...
class Result extends StatelessWidget {
  ...
  Result({required this.bmi,required this.bodyType,required this.indication});
  ...
  Widget build(BuildContext context) {
    return Column(
crossAxisAlignment: CrossAxisAlignment.strimport 'package:bmi_calculator/constants/styles.dart';
import 'package:flutter/material.dart';
import '../logic/types.dart';
class Result extends StatelessWidget {
  final String bodyType ;
